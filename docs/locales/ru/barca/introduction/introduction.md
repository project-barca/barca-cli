...
После установки в вашей среде вы можете запускать **Barca** непосредственно из командной строки вашей операционной системы.

<br/>

Просмотрите доступные команды **Barca CLI**, набрав:
После установки в вашей среде вы можете запускать **Barca** непосредственно из командной строки вашей операционной системы.
...
Запустите `barca <command> --help`, чтобы увидеть параметры, специфичные для команды.

<br/>

Ниже мы можем получить подробные описания для каждой команды:


| Команда        | конечно           | Описание  |
| ------------- |:-------------:| -----:|
| `init`      | `i` | Начать новый проект |
| `add`      | `a`      |   Добавьте ресурсы в проект |
| `insert`      | `is`      |   Вставьте функции в проект |
| `integrate` | `in`      |    Интеграция с технологиями |
| `scan` | `sc`      |    проект сканирования |
| `update` | `up`      |    обновить проект |
| `imigrate` | `im`      |    Иммиграция технологий из проекта |
| `deploy` | `d`      |    Реализовать проект |
