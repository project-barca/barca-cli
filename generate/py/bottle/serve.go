...
func Server(port, directory, lang string) {
	...
	if os.IsNotExist(errorPath) {
		...
		line := "from bottle import Bottle, run\n"
		data := []byte(line)
		...
		line2 := "\napp = Bottle()\n\n@app.route('/')\ndef home():\n    return \"Olá, você está usando Barca CLI\"\n\nrun(app, host='localhost', port=" + port + ")\n"
		data2 := []byte(line2)
		...
		dependencies.PackagePip(directory, "main.py", lang, "bottle")
